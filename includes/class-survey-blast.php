    ...
    public static function build_message($segment, $display_name = '', $user_id = 0)
    {
        ...
        if ($segment === 'finished' || $segment === 'near') {
            ...
            $body  = "ยินดีด้วยครับ จบครบทุกบทแล้ว\n\n"
                   ...
                   . "สิ่งที่ตอบวันนี้จะกำหนดว่าจะเพิ่มอะไรเข้าไปบ้าง (เนื้อหาที่เพิ่มฟรีสำหรับนักเรียนปัจจุบันทุกคน)\n\n"
                   . "ตอบเสร็จเลือกอีบุ๊กเจาะลึกฟรีได้เลย 1 เล่มครับ";
            $cta   = 'รับอีบุ๊ก และตอบแบบสอบถาม';
            $note  = 'ใช้เวลาประมาณ 3 นาที';
            $c1    = '#00AB8E'; $c2 = '#0076BA';
        } else {
            $hero  = 'เราอยากรู้ว่า';
